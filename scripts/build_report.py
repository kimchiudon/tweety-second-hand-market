...
def build(args) -> None:
    ...
    story.extend([
        Spacer(1, 5 * mm),
        p("최종 결과", st["h2"]),
        bullet("자동 보안·기능 테스트 26개 전부 성공", st["body"]),
    ...
    story.extend([
        ...
        p("실행 결과: 26 tests / 26 passed / 0 failed / 0 errors", st["callout"]),
        PageBreak(),
    ])
    ...
    story.extend([
        ...
        p("유지보수 계획", st["h2"]),
        bullet("인증·세션·거래·관리자 변경 시 26개 전체 회귀 테스트 실행", st["body"]),
    ...
    story.extend([
        ...
        table([
            ...
            ["테스트", "공격·경계·권한 테스트 생성", "26개 자동 테스트 전부 실행"],
